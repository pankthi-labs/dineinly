...
// A Waiter/Kitchen caller reaches these procedures but every query/mutation
// here comes back empty or raises — RLS and the RPCs' own role checks do the
// real enforcement, matching every other router in this app.
