...
// Owner/Admin invited by another Owner/Admin may hold any role. A Manager
// caller never gets "owner" offered — docs/product.md § RBAC: "Managers may
// not invite Owners." Server-enforced too (invite_staff/update_staff,
// supabase/migrations/20260816164344_add_staff_roster_rpcs.sql); this only
// keeps the form from offering a choice the server would reject.
...
// "Owner reassignment"). Past that, a Manager may manage anyone except an
// Owner (same RBAC rule as above); an Owner/Admin may manage anyone.
function canManageRow(
	...
	if (viewerIsAdmin || viewerRole === "owner") return true;
