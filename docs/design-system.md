...
- **Approved:** Add to Cart, Confirm Order, Send to Kitchen, Preparing, Ready, Served, Picked Up, View Bill, Request Bill, Generate Bill, Waive Item, Cancel Item, Mark Bill Settled, Close Session, Token Number, Show at Counter, Ready for Pickup, Dineinly Menu, Dineinly Guest, Dineinly Counter, Dineinly One, Dineinly Experience, Experience, Payment timing, Full-Service, Quick-Service.
